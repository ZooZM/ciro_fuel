...
class AppColors {
  ...
  static const _DarkPalette dark = _DarkPalette(
    ...
    blueTint: Color(0xFF1A2540), // derived — dark-mode tint (subtle blue-tinted surface)
    ...
    brandOrange: Color(0xFFFF7A3D), // derived — lightened for contrast on dark bg
    orangeTint: Color(0xFF3A2416), // derived

    brandPurple: Color(0xFFA976F0), // derived — lightened for contrast on dark bg
    ...
    textTertiary: Color(0xFF6B7280), // derived — reused light tertiary, works on dark too
...
// Same shape as _LightPalette; kept as a distinct type for clarity at call sites.
...
class AppTheme {
  ...
  static ThemeData get lightTheme => ThemeData(
        ...
        textTheme: _textTheme(AppColors.light.textPrimary, AppColors.light.textSecondary),
      );
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        textTheme: _textTheme(AppColors.dark.textPrimary, AppColors.dark.textSecondary),
      );
