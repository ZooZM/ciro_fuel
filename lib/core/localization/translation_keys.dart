...
abstract final class CreateOrderKeys {
  static const String title = 'create_order.title';
  static const String subtitle = 'create_order.subtitle';

  static const String sectionStation = 'create_order.section_station';
  static const String sectionGrade = 'create_order.section_grade';
  static const String sectionQuantity = 'create_order.section_quantity';
  static const String sectionDelivery = 'create_order.section_delivery';
  static const String sectionPayment = 'create_order.section_payment';

  static const String currentStation = 'create_order.current_station';
  static const String favouriteStations = 'create_order.favourite_stations';
  static const String changeStation = 'create_order.change_station';

  static const String chooseFuelTypeFirst =
      'create_order.choose_fuel_type_first';

  static const String scheduleTitle = 'create_order.schedule_title';
  static const String scheduleSubtitle = 'create_order.schedule_subtitle';
  static const String todayTitle = 'create_order.today_title';
  static const String todaySubtitle = 'create_order.today_subtitle';
  static const String fastestTitle = 'create_order.fastest_title';
  static const String fastestSubtitle = 'create_order.fastest_subtitle';

  static const String notesLabel = 'create_order.notes_label';
  static const String notesHint = 'create_order.notes_hint';

  static const String confirmOrder = 'create_order.confirm_order';

  static const String selectAtLeastOneFuelType =
      'create_order.select_at_least_one_fuel_type';

  /// Takes a `grade` named argument.
  static const String enterValidQuantityFor =
      'create_order.enter_valid_quantity_for';
}
...
abstract final class OrderDetailKeys {
  ...
  /// Takes `amount` and `percent` named arguments.
