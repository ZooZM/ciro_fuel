...
/// code sent to it.
class DriverVerifyPhoneScreen extends StatefulWidget {
  const DriverVerifyPhoneScreen({super.key});

  @override
  State<DriverVerifyPhoneScreen> createState() => _DriverVerifyPhoneScreenState();
}

class _DriverVerifyPhoneScreenState extends State<DriverVerifyPhoneScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ProfileIdentity(station: 'driver_mock_profile.station_alhamd'.tr()),
              const SizedBox(height: 32),
              StepTracker(
                steps: [
                  StepItem(
