...
class OrderDetailScreen extends StatelessWidget {
  const OrderDetailScreen({super.key, required this.orderId, this.mockState = MockOrderState.pendingReview});
...
class _OrderDetailView extends StatefulWidget {
  const _OrderDetailView({required this.orderId, this.mockState = MockOrderState.pendingReview});
...
class _OrderDetailViewState extends State<_OrderDetailView> {
      ...
      child: Column(
        children: [
          ...
          const Row(
            ...
            children: [
              Expanded(
                child: _SummaryColumn(title: 'رسوم النقل', value: '1,200.00 ريال'),
              ),
              Text(
                '+',
                style: TextStyle(color: Color(0xFF1E5FFF), fontSize: 18, fontWeight: FontWeight.w700),
              ),
              Expanded(
                child: _SummaryColumn(title: 'ضريبة القيمة المضافة\n(%15)', value: '6,060.00 ريال'),
              ),
              Text(
                '=',
                style: TextStyle(color: Color(0xFF1E5FFF), fontSize: 18, fontWeight: FontWeight.w700),
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: _receiptAccent, fontSize: 16, fontWeight: FontWeight.w700),
                ),
                const SizedBox(height: 24),
                _buildBreakdownRow('الرقم المرجعي', '#889241035', isRightGray: true),
                const SizedBox(height: 8),
                ...
                TextButton.icon(
                  ...
                  label: const Text(
                    'تنزيل الإيصال',
                    style: TextStyle(color: _kBlue, fontSize: 14, fontWeight: FontWeight.w700),
                  ),
                ),
                const SizedBox(height: 8),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const Text(
                'الإجمالي',
                style: TextStyle(color: _kNavy, fontSize: 16, fontWeight: FontWeight.w800),
              ),
              RichText(
                text: const TextSpan(
                  children: [
                    TextSpan(
                      text: '600,120.00 ',
                      style: TextStyle(color: _kGreen, fontSize: 18, fontWeight: FontWeight.w800),
                    ),
                    TextSpan(
                      text: 'ر.س',
  ...
  Widget _buildBreakdownRow(String title, String value, {bool isMain = false, bool isRightGray = false}) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(
                ...
                Row(
                  children: [
                    const Expanded(
                      child: Column(
                        children: [
                          _TransitDetailRow(label: 'بنزين 95', value: '20,000 لتر'),
                          SizedBox(height: 12),
                          _TransitDetailRow(
                            label: 'السائق',
                            value: 'أحمد السبيعي',
                ...
                child: SizedBox(
                  ...
                  child: FilledButton.icon(
                    onPressed: () {
                      Navigator.of(
                        context,
                      ).push(MaterialPageRoute<void>(builder: (_) => const TrackOrderScreen()));
                    },
              ...
              Expanded(
                ...
                child: SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    icon: const Icon(Icons.phone_outlined, color: _kNavy, size: 16),
                    label: const Text(
                      'تواصل مع السائق',
                      maxLines: 1,
                      style: TextStyle(color: _kNavy, fontSize: 10.5, fontWeight: FontWeight.w700),
                    ),
                  ),
                ),
              ),
      ...
      child: Column(
        children: [
          const Text(
            ...
            style: TextStyle(color: Color(0xFF0F1B2E), fontSize: 14, fontWeight: FontWeight.w800),
          ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Image.asset('assets/Icons/QR Code.png', width: 72, height: 72),
                    const SizedBox(height: 4),
                    const Text('اعرض هذا للسائق', style: TextStyle(color: Color(0xFF8A93A6), fontSize: 8)),
                  ],
                ),
              ),
              const Padding(
                ...
                child: Text(
                  'أو',
                  style: TextStyle(color: Color(0xFF0F1B2E), fontSize: 12, fontWeight: FontWeight.w700),
                ),
              ),
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      const Text(
                        'كود الإستلام',
                        style: TextStyle(color: Color(0xFF0F1B2E), fontSize: 12, fontWeight: FontWeight.w800),
                      ),
                      const SizedBox(height: 8),
                      Row(
                      ...
                      const SizedBox(height: 8),
                      const Text('صالح لمدة', style: TextStyle(color: Color(0xFF8A93A6), fontSize: 10)),
                      const SizedBox(height: 4),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          ...
                          const Icon(Icons.timer_outlined, color: Color(0xFF17A34A), size: 14),
                        ],
                      ),
                    ],
                  ),
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFFE4F7EC), borderRadius: BorderRadius.circular(8)),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Text(
                ...
                const Icon(Icons.verified_user_outlined, color: Color(0xFF17A34A), size: 14),
              ],
            ),
          ),
        ],
        ...
        children: [
                ...
                child: SizedBox(
                  ...
                  child: FilledButton.icon(
                    onPressed: () {
                      Navigator.of(
                        context,
                      ).push(MaterialPageRoute<void>(builder: (_) => const InvoicePaymentScreen()));
                    },
                    style: FilledButton.styleFrom(
                      backgroundColor: _kBlue,
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
          ...
          SizedBox(
            ...
            child: FilledButton.icon(
              ...
              icon: const Icon(Icons.bookmark_outline, size: 18, color: Colors.white),
              label: const Text(
                'إدفع المرة القادمة',
          ...
          Center(
            child: TextButton.icon(
              onPressed: () {},
              icon: const Icon(Icons.credit_card_outlined, color: _kNavy, size: 18),
              label: const Text(
                'أطلب حد إئتماني',
                style: TextStyle(color: _kNavy, fontSize: 13, fontWeight: FontWeight.w700),
              ),
            ),
          ),
        ],
  ...
  Widget _buildPendingOrderStatus() {
    return OrderCard(
      ...
      trailing: const Text(
        'قيد المراجعة',
        style: TextStyle(color: _kBlue, fontSize: 15, fontWeight: FontWeight.w800),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
      ...
      child: Column(
        children: [
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  const Text('صالح حتى 9 صفر 1446', style: TextStyle(color: Color(0xFF1E5FFF), fontSize: 10)),
                ],
              ),
              Row(
                children: [
                  Container(
                    ...
                    child: const Text(
                      'نشط',
                      style: TextStyle(color: Color(0xFF17A34A), fontSize: 11, fontWeight: FontWeight.w700),
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.credit_card_outlined, color: Color(0xFFF97316), size: 20),
                  ),
                ],
              ),
            ],
          ...
          ClipRRect(
            ...
            child: Row(
              children: [
                Expanded(flex: 63, child: Container(height: 6, color: const Color(0xFFF97316))),
                Expanded(flex: 37, child: Container(height: 6, color: const Color(0xFFE6E9F0))),
              ],
            ),
          ),
          const SizedBox(height: 8),
          Row(
            ...
            children: [
              const Flexible(
                child: Text(
                  'من 200,000.00 ر.س',
                  style: TextStyle(color: _kNavy, fontSize: 11, fontWeight: FontWeight.w700),
                ),
              ),
              const SizedBox(width: 8),
              const Flexible(
          ...
          Container(
            ...
            child: const Text(
              ...
              style: TextStyle(color: Color(0xFF17A34A), fontSize: 13, fontWeight: FontWeight.w700),
            ),
          ),
          const SizedBox(height: 12),
          SizedBox(
  ...
  Widget _buildSupportFab() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        boxShadow: const [BoxShadow(color: Color(0x331E5FFF), blurRadius: 10, offset: Offset(0, 4))],
      ),
      child: Material(
...
class _StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: _kChipBg, borderRadius: BorderRadius.circular(8)),
      child: Text(
        label,
...
class _TransitDetailRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        if (icon != null) Icon(icon, color: _kGreen, size: 20) else const SizedBox(width: 20),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: CustomPaint(
        ...
        child: const Center(child: Icon(Icons.schedule, color: _kOrange, size: 30)),
      ),
    );
  }
}
...
class _DashedRingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final ring = Path()
      ..addOval(Rect.fromCircle(center: size.center(Offset.zero), radius: size.width / 2 - 6));
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('الوصول خلال', style: TextStyle(color: _kNavy, fontSize: 8)),
              Text(
                '$minutes',
                style: const TextStyle(
                  color: _kGreen,
              ...
              const Text('دقيقة', style: TextStyle(color: _kGreen, fontSize: 8)),
            ],
          ),
        ),
      ),
    ...
    return ClipRect(
      child: SizedBox(
        ...
        child: OverflowBox(
          maxWidth: _canvas,
          maxHeight: _canvas,
          child: Image.asset('assets/Order/Done.gif', width: _canvas, height: _canvas),
        ),
      ),
    );
  }
            ...
            child: Row(
              children: [
                Text(
                  ...
                  style: const TextStyle(color: _kGreen, fontSize: 10, fontWeight: FontWeight.w700),
                ),
                const SizedBox(width: 4),
                Icon(
